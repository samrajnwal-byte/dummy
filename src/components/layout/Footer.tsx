        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1 border-r-0 md:border-r border-zinc-800/50 pr-8">
            ...
            <div className="flex items-center gap-4 text-zinc-400">
              ...
              <a
                href="https://www.instagram.com/alphafuel96/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Instagram"
                className="hover:text-brand transition-colors focus:ring-2 focus:ring-brand focus:outline-none rounded-sm"
              >
              ...
              <a
                href="https://www.facebook.com/share/17smwQ1HWS/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="hover:text-brand transition-colors focus:ring-2 focus:ring-brand focus:outline-none rounded-sm"
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link
                  to="/products"
                  className="text-zinc-400 hover:text-brand text-sm transition-colors"
                >
                  All Products
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-zinc-400">
              ...
              <li>
                <a
                  href="mailto:support@alphafuel.in"
